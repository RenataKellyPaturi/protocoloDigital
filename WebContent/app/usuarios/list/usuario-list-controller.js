'use strict';
app.controller('UsuarioListController', ['$http', '$location', '$scope','$routeParams', function($http, $location, $scope, $routeParams) {

	var self = this;
	var appCtrl = $scope.appCtrl;
	
	$scope.page = 'usuario-list';
	...
	self.listarUsuarios = function () {

		appCtrl.loadSpiner(true);

		$http.get( "api/users/"+"?radom="+Math.random()).then(function(response) {
